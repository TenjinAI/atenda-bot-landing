    ...
    <section id="contato" className="w-full py-20 px-4 bg-gradient-to-br from-blue-500 to-blue-700 text-white">
      <div className="container max-w-6xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          🔹 Pronto para elevar seu atendimento no WhatsApp?
        </h2>
        ...
        <a
          href="mailto:contato@atenda.bot?subject=Contato%20-%20Atenda.bot&body=Ol%C3%A1%2C%20gostaria%20de%20conversar%20sobre%20atendimento%20no%20WhatsApp%20(API%20oficial)."
